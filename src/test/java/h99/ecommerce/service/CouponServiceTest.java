...
public class CouponServiceTest {
    ...
    void issue_coupon_success() {
        ...
        when(userCouponRepository.generateId()).thenReturn(1);
    ...
    void get_user_coupons_success() {
        // given
        int userId = 100;
        UserCoupon userCoupon2 = new UserCoupon(2, userId, 2, false, null, null);
    ...
    void get_available_user_coupons_success() {
        ...
        when(couponRepository.findOne(1)).thenReturn(coupon);
    ...
    void get_available_user_coupons_exclude_used() {
        // given
        int userId = 100;
        UserCoupon usedCoupon = new UserCoupon(2, userId, 2, true, LocalDateTime.now(), null);
    ...
    void validate_user_coupon_already_used_fail() {
        ...
        int userId = 100;
        int userCouponId = 1;
        UserCoupon usedCoupon = new UserCoupon(1, 100, 1, true, LocalDateTime.now(), null);
